...
@section('content')
	...
	<div class="page-header"><h3><span class="glyphicon glyphicon-list-alt"></span> {{ $result->prefixkey }} :: Edit</h3></div>
	...
	<form id="reportform" class="form-horizontal" method="post" action="" autocomplete="off" role="form">
		...
		<div class="form-group {{ $errors->has('prefixkey') ? 'has-error' : '' }}">
			...
			<div class="col-md-10">
				<input type="text" class="form-control" name="prefixkey" id="prefixkey" value="{{ old('prefixkey', $result->prefixkey) }}" />
			</div>
		</div>
		...
		<div class="form-group">
			<div class="col-md-offset-2 col-md-10">
				...
				<a href="{{ route('qrs.notification.show', $result->id) }}" class="btn btn-default"><span class="glyphicon glyphicon-circle-arrow-left"></span> Back</a>
			</div>
		</div>
	</form>
