...
@section('title')
Document Type Setting :: Edit ::
@parent
@endsection

@section('content')

	<div class="page-header"><h3><span class="glyphicon glyphicon-file"></span> Edit</h3></div>
	...
	<form class="form-horizontal" method="post" action="" autocomplete="off" role="form">
		...
		<div class="form-group">
			<div class="col-md-offset-2 col-md-10">
				...
				<a href="{{ route('qrs.document.show', $result->id) }}" class="btn btn-default"><span class="glyphicon glyphicon-circle-arrow-left"></span> Back</a>
			</div>
		</div>
