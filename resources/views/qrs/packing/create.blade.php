...
@section('title')
Packing Setting :: Create ::
@parent
@endsection

@section('content')

	<div class="page-header"><h3><span class="glyphicon glyphicon-inbox"></span> Create</h3></div>
	...
	<form class="form-horizontal" method="post" action="" autocomplete="off" role="form">
		...
		<div class="form-group">
			<div class="col-md-offset-2 col-md-10">
				...
				<a href="{{ route('qrs.packing.index') }}" class="btn btn-default"><span class="glyphicon glyphicon-circle-arrow-left"></span> Back</a>
			</div>
		</div>
