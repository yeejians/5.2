...
@section('content')
	...
	<div class="page-header"><h3><span class="glyphicon glyphicon-flag"></span> Edit</h3></div>
	...
	<form class="form-horizontal" method="post" action="" autocomplete="off" role="form">
		...
		<div class="form-group {{ $errors->has('shortname') ? 'has-error' : '' }}">
			...
			<div class="col-md-10">
				<input type="text" class="form-control" name="shortname" id="shortname" value="{{ old('shortname', $result->shortname) }}" />
			</div>
		</div>
		...
		<div class="form-group {{ $errors->has('sapcode') ? 'has-error' : '' }}">
			...
			<div class="col-md-10">
				<input type="text" class="form-control" name="sapcode" id="sapcode" value="{{ old('sapcode', $result->sapcode) }}" />
			</div>
		</div>
